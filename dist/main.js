...
const interactDOM = function(){
    ...
    const appendElementAndDefineContentForecast = function (container, obj, day) {
        ...
        dayDate.textContent = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(obj.forecast.forecastday[day].date.replaceAll('-', '/')), "EEEE',' dd MMM")}`
