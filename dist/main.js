...
function handleSearch (){
    ...
    const toggleCelsiusFahrenheit = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('toggleCelsiusFahrenheit')
    let city
    let unitStatus
    cityInputForm.addEventListener('submit', async (e) =>{
        ...
        if(!cityInput.validity.valid){
            ...
            (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().formReset('searchCity')
           }
        }  
    })
}
...
function handleContentShow (obj, boolean){
    ...
    const forecastWeather = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('forecastWeather')
    const forecastOne = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('forecastOne')
    const forecastTwo = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('forecastTwo')
    const forecastThree = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('forecastThree')
    const forecastFour = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('forecastFour')
    const forecastFive = (0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().hookDOMelement('forecastFive')
    ...
    ;(0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().appendElementAndDefineContentCurrent(currentWeather, obj, boolean)
    ;(0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().appendElementAndDefineContentForecast(forecastOne, obj, 1, boolean)
    ;(0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().appendElementAndDefineContentForecast(forecastTwo, obj, 2, boolean)
    ;(0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().appendElementAndDefineContentForecast(forecastThree, obj, 3, boolean)
    ;(0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().appendElementAndDefineContentForecast(forecastFour, obj, 4, boolean)
    ;(0,_interactDOM__WEBPACK_IMPORTED_MODULE_1__["default"])().appendElementAndDefineContentForecast(forecastFive, obj, 5, boolean)
}
...
async function searchWeather(searchCity){
        try{
            ...
            console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(forecastData.forecast.forecastday[1].date.replaceAll('-', '/')), "EEEE',' dd MMM"))
            return forecastData
        } catch(err){
            return err
        } 
